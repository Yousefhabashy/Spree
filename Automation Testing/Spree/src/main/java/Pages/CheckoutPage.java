...
public class CheckoutPage extends PagesBase {
    ...
    @FindBy(xpath = "/html/body/div[2]/div/div[1]/div/div/div[3]/div[2]/turbo-frame/div/div/ul/li[1]/div/label/turbo-frame/div[1]/div[1]")
    ...
    @FindBy(xpath = "/html/body/div[2]/div/div[1]/div/div/div[3]/form/div[1]/div/div/div/ul/li[2]")
    WebElement premiumDeliveryMethod;

    public void selectPremium() {

        premiumDeliveryMethod.click();
        clickElementJS(deliverySaveAndContinueButton);
    }

    @FindBy(xpath = "/html/body/div[2]/div/div[1]/div/div/div[3]/form/div[1]/div/div/div/ul/li[3]")
    WebElement nextDayDeliveryMethod;

    public void selectNextDay() {

        nextDayDeliveryMethod.click();
        clickElementJS(deliverySaveAndContinueButton);
    }
    ...
    @FindBy(xpath = "//*[@id=\"checkout_line_items\"]/div/div[1]/div[2]/p[1]")
    public WebElement product1Title;

    @FindBy(xpath = "//*[@id=\"checkout_line_items\"]/div/div[1]/div[2]/p[2]")
    public WebElement product1ColorAndSize;

    @FindBy(xpath = "/html/body/div[2]/div/div[2]/div/div/div/div/div/turbo-frame/div/div[1]/div[3]")
    public WebElement product1Price;

    @FindBy(xpath = "//*[@id=\"checkout_line_items\"]/div/div[2]/div[2]/p[1]")
    public WebElement product2Title;

    @FindBy(xpath = "//*[@id=\"checkout_line_items\"]/div/div[2]/div[2]/p[2]")
    public WebElement product2ColorAndSize;

    @FindBy(xpath = "/html/body/div[2]/div/div[2]/div/div/div/div/div/turbo-frame/div/div[2]/div[3]")
    public WebElement product2Price;

    @FindBy(xpath = "//*[@id=\"checkout_line_items\"]/div/div[3]/div[2]/p[1]")
    public WebElement product3Title;

    @FindBy(xpath = "//*[@id=\"checkout_line_items\"]/div/div[3]/div[2]/p[2]")
    public WebElement product3ColorAndSize;

    @FindBy(xpath = "/html/body/div[2]/div/div[2]/div/div/div/div/div/turbo-frame/div/div[3]/div[3]")
    ...
    @FindBy(xpath = "//*[@id=\"checkout_coupon_code\"]/form/div/button")
    WebElement applyPromoCode;

    public void setPromoCode(String promoCode) {

        setElementText(promoCodeBox, promoCode);
